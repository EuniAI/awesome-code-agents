...
📚 *Currently collected:* **`372` papers and products** — *(Last update: 2025-11-06)*
<!-- END PAPERS SUMMARY -->
...
### 🔁 Code Translation
> Agent-based translation of codebases and files between programming languages.

<!-- START PAPERS:code_translation -->
