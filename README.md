...
📚 *Currently collected:* **`389` papers and products** — *(Last update: 2025-11-14)*
<!-- END PAPERS SUMMARY -->
...
- **SWE-Compass: Towards Unified Evaluation of Agentic Coding Abilities for Large Language Models.**
  _Jingxuan Xu, Ken Deng, Weihao Li, Songwei Yu, Huaixi Tang, Haoyang Huang, Zhiyi Lai, Zizheng Zhan, Yanan Wu, Chenchen Zhang, et al._ arXiv 2025.
